...
public abstract class BaseIntegration implements Integration {
	...
	public abstract String startFlow(String id, long timeout) throws Exception;

	public abstract String restartFlow(String id, long timeout) throws Exception;
	
	public abstract String stopFlow(String id, long timeout) throws Exception;
	...
	public abstract String getFlowStats(String id, boolean fullStats, boolean includeMetaData, boolean includeSteps, String filter) throws Exception;
	...
	public abstract List<Expression> validateExpressions(List<Expression> expressions, boolean isPredicate);
