...
public final class EncryptionUtil {
    ...
    public String encrypt(String plainText) {
        ...
        SecretKeySpec secretKey =
                new SecretKeySpec(generateKey(password, salt), CIPHER_ALGORITHM);
    ...
    public String decrypt(String encryptedText) {
        ...
        if (!encryptedText.startsWith(ENCODE_PREFIX)
                || !encryptedText.endsWith(ENCODE_SUFFIX)) {
            throw new IllegalArgumentException("Invalid encrypted text format.");
        }

        String contents = encryptedText.substring(
                ENCODE_PREFIX.length(),
                encryptedText.length() - ENCODE_SUFFIX.length()
        );
        ...
        try {
            ...
            // Decrypt and authenticate the encrypted text
            return decryptWithIv(secretKey, iv, encryptedBytes);

        } catch (IllegalArgumentException e) {
            throw new IllegalArgumentException("Invalid encrypted text format.", e);
        }
    }
    ...
    private String decryptWithIv(
        ...
        try {
            ...
            // Includes authentication failures caused by modified
            // ciphertext or an incorrect password.
